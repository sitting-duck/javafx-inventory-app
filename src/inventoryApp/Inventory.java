...
/**
 * Inventory class that holds all the Parts and all the Products
 */
public class Inventory {
    ...
    public static void addPart(Part newPart) {
        if(newPart instanceof InHousePart) {
            allParts.add((InHousePart)newPart);
        } else if (newPart instanceof OutSourcedPart) {
            allParts.add((OutSourcedPart)newPart);
        }
    }
