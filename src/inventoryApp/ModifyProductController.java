...
/**
 * The controller for the ModifyProduct form
 */
public class ModifyProductController implements Initializable {
     ...
     * @param _product - new product to set
     */
     ...
     * @throws IOException - called if the MainForm is not found to be loaded
     *
     ...
     * @param actionEvent - user clicks cancel or Save Button
     * @throws IOException - thrown if the MainForm is not found
     */
     ...
     * @param actionEvent - user clickes the RemovePartBtn
     */
